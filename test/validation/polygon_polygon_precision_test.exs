defmodule Intersect.Validation.PolygonPolygonPrecisionTest do
  ...
  test "18-004 - AA - hole close to shell" do
    a = "POLYGON ((10 100, 10 10, 100 10, 100 100, 10 100),(90 90, 11 90, 10 10, 90 11, 90 90))" |> Geo.WKT.decode!
  ...
  test "18-005 - mAA - shells close together" do
    a = "MULTIPOLYGON (((0 0, 100 0, 100 20, 0 20, 0 0)),((0 40, 0 21, 100 20, 100 40, 0 40)))" |> Geo.WKT.decode!
  ...
  test "18-010 - AA - B hole close to shell, A coincident with B" do
    ...
    b = "POLYGON ((10 100, 10 10, 100 10, 100 100, 10 100),(90 90, 11 90, 10 10, 90 11, 90 90))" |> Geo.WKT.decode!
  ...
  test "18-013 - AA - sliver triangle with multiple intersecting boxes" do
    a = "MULTIPOLYGON (((1 4, 1 1, 2 1, 2 4, 1 4)),((3 4, 3 1, 4 1, 4 4, 3 4)),((5 4, 5 1, 6 1, 6 4, 5 4)),((7 4, 7 1, 8 1, 8 4, 7 4)),((9 4, 9 1, 10 1, 10 4, 9 4)))" |> Geo.WKT.decode!
  ...
  test "18-014 - AA - Polygon with hole with outward sliver, cut by polygon" do
    a = "POLYGON ((20 40, 20 200, 180 200, 180 40, 20 40),(180 120, 120 120, 120 160, 60 120, 120 80, 120 119, 180 120))" |> Geo.WKT.decode!
  ...
  test "18-016 - AA - Polygon with inward sliver touching hole, cut by polygon" do
    a = "POLYGON ((20 40, 20 200, 180 200, 180 120, 140 120, 180 119, 180 40, 20 40),(140 160, 80 120, 140 80, 140 160))" |> Geo.WKT.decode!
