defmodule Intersect.Validation.PolygonComplexATest do
  ...
  test "08-001 - AC A-shells overlapping B-shell at A-vertex" do
    ...
    b = "MULTIPOLYGON (((80 40, 120 40, 120 80, 80 80, 80 40)),((120 80, 160 80, 160 120, 120 120, 120 80)),((80 120, 120 120, 120 160, 80 160, 80 120)),((40 80, 80 80, 80 120, 40 120, 40 80)))" |> Geo.WKT.decode!
