defmodule Intersect.Validation.PointPolygonATest do
  ...
  test "03-002 - P/A-2-2: a point outside a converx polygon" do
    ...
    b = "POLYGON ((110 230, 80 160, 20 160, 20 20, 200 20, 200 160, 140 160, 110 230))" |> Geo.WKT.decode!
  ...
  test "03-003 - P/A-2-3: a point outside a concave polygon" do
    ...
    b = "POLYGON ((20 160, 80 160, 110 100, 140 160, 200 160, 200 20, 20 20, 20 160))" |> Geo.WKT.decode!
  ...
  test "03-004 - P/A-2-4: dim(0){A.P.Int = B.A.Ext}" do
    ...
    b = "POLYGON ((20 150, 100 150, 40 50, 170 50, 110 150, 190 150, 190 20, 20 20, 20 150))" |> Geo.WKT.decode!
  ...
  test "03-005 - P/A-2-5: a point outside a concave polygon" do
    a = "POINT (100 70)" |> Geo.WKT.decode!
    b = "POLYGON ((20 150, 100 150, 40 50, 160 50, 100 150, 180 150, 180 20, 20 20, 20 150))" |> Geo.WKT.decode!
  ...
  test "03-011 - P/Ah-2-1: a point outside of polygon with a hole" do
    ...
    b = "POLYGON ((190 190, 360 20, 20 20, 190 190),(280 50, 100 50, 190 140, 280 50))" |> Geo.WKT.decode!
  ...
  test "03-020 - P/A2h-3-1: a point on the touching point of two holes in a polygon" do
    ...
    b = "POLYGON ((190 190, 360 20, 20 20, 190 190),(90 50, 150 110, 190 50, 90 50),(190 50, 230 110, 290 50, 190 50))" |> Geo.WKT.decode!
  ...
  test "03-021 - P/A2h-3-2: a point on the touching point of two holes in a polygon" do
    ...
    b = "POLYGON ((190 190, 360 20, 20 20, 190 190),(180 140, 180 40, 80 40, 180 140),(180 90, 210 140, 310 40, 230 40, 180 90))" |> Geo.WKT.decode!
  ...
  test "03-039 - P/mA-3-1: a point on the touching point of two polygons" do
    ...
    b = "MULTIPOLYGON (((20 100, 20 20, 100 20, 100 100, 20 100)),((100 180, 100 100, 180 100, 180 180, 100 180)))" |> Geo.WKT.decode!
  ...
  test "03-042 - P/mA-3-4: a point touching a polygon's boundary where the boundaries touch at a point" do
    ...
    b = "MULTIPOLYGON (((110 110, 20 200, 200 200, 110 110),(110 110, 80 180, 140 180, 110 110)),((110 110, 20 20, 200 20, 110 110),(110 110, 80 40, 140 40, 110 110)))" |> Geo.WKT.decode!
