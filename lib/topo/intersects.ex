defmodule Topo.Intersects do
  ...
  def intersects?(%Geo.Point{} = a, %Geo.MultiLineString{} = b), do: intersects_any?(a, b, Geo.LineString)
  ...
  def intersects?(%Geo.Point{} = a, %Geo.MultiPolygon{} = b), do: intersects_any?(a, b, Geo.Polygon)

  def intersects?(%Geo.MultiPoint{} = a, %Geo.Point{} = b), do: intersects?(b, a)
  def intersects?(%Geo.MultiPoint{} = a, %Geo.MultiPoint{} = b), do: intersects_any?(a, b, Geo.Point)
  def intersects?(%Geo.MultiPoint{} = a, %Geo.LineString{} = b), do: intersects_any?(b, a, Geo.Point)
  def intersects?(%Geo.MultiPoint{} = a, %Geo.MultiLineString{} = b), do: intersects_any?(a, b, Geo.LineString)
  def intersects?(%Geo.MultiPoint{} = a, %Geo.Polygon{} = b), do: intersects_any?(b, a, Geo.Point)
  def intersects?(%Geo.MultiPoint{} = a, %Geo.MultiPolygon{} = b), do: intersects_any?(a, b, Geo.Polygon)
  ...
  def intersects?(%Geo.LineString{coordinates: a}, %Geo.LineString{coordinates: b}), do: LineLine.relate(a, b) != :disjoint
  def intersects?(%Geo.LineString{} = a, %Geo.MultiLineString{} = b), do: intersects_any?(a, b, Geo.LineString)
  ...
  def intersects?(%Geo.LineString{} = a, %Geo.MultiPolygon{} = b), do: intersects_any?(a, b, Geo.Polygon)
  ...
  def intersects?(%Geo.MultiLineString{} = a, %Geo.MultiLineString{} = b), do: intersects_any?(a, b, Geo.LineString)
  def intersects?(%Geo.MultiLineString{} = a, %Geo.Polygon{} = b), do: intersects_any?(b, a, Geo.LineString)
  def intersects?(%Geo.MultiLineString{} = a, %Geo.MultiPolygon{} = b), do: intersects_any?(a, b, Geo.Polygon)
  ...
  def intersects?(%Geo.Polygon{coordinates: [a_exterior | a_holes]}, %Geo.Polygon{coordinates: [b_exterior | b_holes]}) do
  ...
  def intersects?(%Geo.Polygon{} = a, %Geo.MultiPolygon{} = b), do: intersects_any?(a, b, Geo.Polygon)
  ...
  def intersects?(%Geo.MultiPolygon{} = a, %Geo.MultiPolygon{} = b), do: intersects_any?(a, b, Geo.Polygon)
